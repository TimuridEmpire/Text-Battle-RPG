...
public class Mage extends Player {
	...
	public int attack(Monster monster) {
		...
		if (this.mana == 0) { //20% chance to attack if you have no mana (avoids the player dying if they run out of mana)
			if (Math.random() < .2) {
	 ...
	 */
	public int manaAttack(int manaCost, Monster monster) {
		if (this.mana >= manaCost) {
